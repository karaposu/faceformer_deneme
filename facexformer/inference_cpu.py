...
def test(args):
    ...
    # weights_path= "/Users/ns/.cache/torch/hub/checkpoints/swin_b-68c6b09e.pth"
    ...
    for key, value in checkpoint.items():
        new_key = key
        # Modify the key names based on the expected structure of your current model
        if 'features' in key:
            new_key = key.replace('features',
                                  'backbone')  # Example adjustment, customize based on your model's architecture
